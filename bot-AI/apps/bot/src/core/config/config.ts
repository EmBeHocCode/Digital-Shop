...
function buildConfig(settings: Settings) {
  return {
    ...
    customSystemPrompt: settings.bot.customSystemPrompt,
    cloudDebug: settings.bot.cloudDebug,
    strangerAutoReply: settings.bot.strangerAutoReply,
    friendDmReplyEnabled: settings.bot.friendDmReplyEnabled,
    privateAutoReply: settings.bot.privateAutoReply,
    ...
    allowAllGroups: settings.allowAllGroups,
    autoReplyGroupIds: settings.autoReplyGroupIds,
    commandAccess: settings.commandAccess,
